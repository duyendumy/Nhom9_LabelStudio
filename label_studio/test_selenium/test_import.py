...
class TestImportData():
    ...
    def test_import_dataset_url(self, test_login):     
    ...
    @allure.severity(severity_level = "CRITICAL") 
    def test_import_upload_image(self, test_login):            
        with allure.step("Select project to import"):
            list_project = driver.find_elements(By.CLASS_NAME, "ls-projects-page__link")
            list_project[0].click()
    ...
    @allure.severity(severity_level = "CRITICAL") 
    def test_import_upload_json(self, test_login):
        with allure.step("Select project to import"):
            list_project = driver.find_elements(By.CLASS_NAME, "ls-projects-page__link")
            list_project[0].click()
    ...
    @allure.severity(severity_level = "CRITICAL") 
    def test_import_upload_text(self, test_login):            
        with allure.step("Select project to import"):
            list_project = driver.find_elements(By.CLASS_NAME, "ls-projects-page__link")
            list_project[0].click()
